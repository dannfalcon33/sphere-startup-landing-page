...
// Social Icons as simple React components
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="md:col-span-2">
                        <h3 className="text-3xl font-bold tracking-wider logo">SPHERE</h3>
                        <p className="mt-4 text-gray-400 max-w-xs">
                            A pioneering AI software startup dedicated to building the next generation of intelligent solutions.
                        </p>
                    </div>

                    {/* Quick Links Section */}
                    <div>
                        <h4 className="text-sm font-semibold tracking-wider text-gray-300 uppercase">Quick Links</h4>
                    ...
                    <div>
                        <h4 className="text-sm font-semibold tracking-wider text-gray-300 uppercase">Follow Us</h4>
                ...
                <div className="mt-8 text-center text-gray-500 text-sm">
                    <p>&copy; {currentYear} Sphere. All Rights Reserved.</p>
                </div>
            </div>
        </footer>
    );
